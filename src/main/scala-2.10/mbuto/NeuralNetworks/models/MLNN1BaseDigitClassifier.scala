package mbuto.NeuralNetworks.models
...
/**
  * Created by gian on 06/05/16.
  */
class MLNN1BaseDigitClassifier(train: DataFrame) //train per los tringindexer
  extends SparkJob[Pipeline]
  with Serializable {



  override def execute(implicit sc: SparkContext, sqlContext: SQLContext): Pipeline = {
